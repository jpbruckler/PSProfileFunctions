...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module PSProfileFunctions.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain PSProfileFunctions.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "PSProfileFunctions.psm1"
        } #validPSM1
